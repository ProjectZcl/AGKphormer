...
# 输出维度数据
x_values = [0.5, 0.05, 0.005, 0.0005, 0.00005]  # 原始x值
y1 = [72.56, 77.50, 97.32, 97.04, 95.43]
y2 = [80.00, 82.62, 97.34, 96.99, 94.88]
...
# 添加标题和轴标签
# ax.set_title('(c)', fontsize=16, fontweight='bold', color='#2c3e50')
ax.set_xlabel('learning rate', fontsize=20, color='black')
...
plt.savefig('learning_rate.pdf', dpi=300, bbox_inches='tight')
